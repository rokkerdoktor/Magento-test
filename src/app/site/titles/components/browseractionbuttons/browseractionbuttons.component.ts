...
@Component({
  selector: 'browseractionbuttons',
  templateUrl: './browseractionbuttons.component.html',
  styleUrls: ['./browseractionbuttons.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class BrowseractionbuttonsComponent  {
